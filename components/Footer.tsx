...
const instaGallery = [
  ...
  'https://images.unsplash.com/photo-1524505971857-2f4a498cbb85?q=80&w=200',
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm font-light leading-relaxed mb-4">
              Pusat estetika &amp; laser premium. Membantu Anda tampil percaya diri dengan
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/" className="text-white/50 hover:text-accent-gold transition-colors cursor-pointer">Beranda</Link>
              </li>
              <li>
                <Link href="/treatments" className="text-white/50 hover:text-accent-gold transition-colors cursor-pointer">Treatment</Link>
              </li>
              <li>
                <Link href="/reservasi" className="text-white/50 hover:text-accent-gold transition-colors cursor-pointer">Reservasi</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-white/50">Jl. Gunawarman No. 21, Kebayoran Baru, Jakarta</span>
              </li>
